    ...
    return (
        <form className="container p-4" id="js-form-chat" onSubmit={sendMessage}>
            ...
            <div className="form-outline">
                ...
                <input onChange={onInputChange} type="email" className="form-control" id="user-email-chat" name="id"
                       placeholder="Enter your email"/>
            </div>

            <div className="form-outline">
                <label className="form-label" htmlFor="sendMessage">Message</label>
                <textarea onChange={onInputChange} name="message" id="sendMessage" placeholder="Write your message"
                          className="form-control"></textarea>
            </div>
            <div>
                <input id="button" type="submit" className="btn btn-primary btn-block mt-4"
